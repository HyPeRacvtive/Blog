                                ...
                                $.each(categoryListDto.Categories.$values,
                                    function (index, category) {
                                       ...
                                       <tr name="${category.Id}">
                                        ...
                                        <td>${category.Note}</td>
                                        <td>${covertToShortDate(category.CreatedDate)}</td>
                                        <td>${category.CreatedByName}</td>
                                        <td>${covertToShortDate(category.ModifiedDate)}</td>
                ...
                if (isValid) {
                    ...
                    const newTableRow = `
                             <tr name="${categoryAddAjaxModel.CategoryDto.Category.Id}">
                                ...
                                <td>${covertToShortDate(categoryAddAjaxModel.CategoryDto.Category.CreatedDate)}</td>
                                <td>${categoryAddAjaxModel.CategoryDto.Category.CreatedByName}</td>
                                <td>${covertToShortDate(categoryAddAjaxModel.CategoryDto.Category.ModifiedDate)}</td>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (categoryDto.ResultStatus === 0) {
                                Swal.fire(
                                    'Silindi!',
                                    `${categoryDto.Category.Name} kategorisi başarıyla silinmiştir.`,
                                    'success'
                                );
